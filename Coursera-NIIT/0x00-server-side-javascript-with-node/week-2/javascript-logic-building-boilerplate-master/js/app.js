...
//   Otherwise :: 'Unfortunately, you are not eligible fo	r a hike'
...
function getAppraisalPct (maxappraisalscore) 
{
	return new Promise((resolve,reject)=>{
		...
		else if (maxappraisalscore > 90) resolve('10% hike to be given');
		else if (maxappraisalscore > 85) resolve('5% hike to be given')
		else resolve('Unfortunately you are not eligible for a hike');
	})
}
